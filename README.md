...
| 懂设计(哲学 / 时机框架 / 联机架构 / 锦囊设计)  | [设计哲学](./docs/explanation/设计哲学.md) · [时机框架](./docs/explanation/时机框架.md) · [联机架构](./docs/explanation/联机架构.md) · [锦囊设计](./docs/explanation/锦囊设计.md) · [组件收口](./docs/design/组件收口.md)   |
