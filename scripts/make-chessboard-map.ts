...
// 段间衔接边全部横纵对齐(或 1 格短斜线);唯一长边是 卧龙→襄阳(东南弧线,
// 恰好沿用原 sanguo 会稽→长安 长距跳转的渲染方式:edgeWaypoints 自动避城弧线)。
...
const entry = {
  ...
  desc: "网格对齐版,大致方位:外环八区、中原居中,许昌—襄阳辅路穿腹地",
  tileCount: propCount,
...
seg("中(行4 自东向西)", ["prop-changan", "prop-xianyang", "prop-hangu", "prop-luoyang", "prop-hulao", "prop-xuchang", "prop-wan", "tile-wolong"]);
seg("下(行8 自东向西)", ["prop-xiangyang", "prop-jiangxia", "prop-wuchang", "prop-chibi", "prop-changsha", "tile-fate-1", "prop-jiangling", "prop-huarong", "prop-lingling", "prop-jiaozhou"]);
