...
- [x] 购买城池会弹窗, 然而玩家根本没有银两或者委任状时, 没得选, 只能放弃, 这个时候就没有必要弹框了, 反正也没有选择 ✅ 已修(2026-08-19):引擎在落无主城时预检——银两不足或委任状为 0 直接跳过决策相位(战报记「银两不足/无委任状,不可购」),不再弹「是否购买」假选择卷轴;bot 路径行为不变(本就买不起不买)
