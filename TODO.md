...
- [ ] 游戏内UI需要优化下, 目前从UI上看不出来自己是那个国家
- [ ] 游戏内UI需要优化下, 移除战报部分, 我感觉这部分似乎没有啥用, 还占用了大量的空间,反而关键的珍宝, 武将没有地方做UI了, 建议把战报作为日志文件存储, 方便AI分析对局定位问题, 对局内不需要了
...
- [ ] 弹框中 公道买卖-按指导价 坐地起价-加价出售 改为公道买卖,坐地起价  不需要后半段解释, 大家能直接看懂
