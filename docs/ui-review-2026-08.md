...
- [x] **G-5 棋盘无常驻回合线索**(仅侧栏呼吸描边);棋盘角加回合 chip(国号色徽+「X的回合」)或活跃棋子常驻高亮环
...
- [x] **G-9 现金变化无就地反馈**(HandPanel.tsx:60-65);变化时 +/− 差值浮标;头部补自己身价
...
- [x] **G-17 城详情×卡详情双层卷轴 z 序冲突**(GameScreen.tsx:196-204 + HandPanel.tsx:170);互斥或弹层栈
...
- [x] **C2 solveLaunch 同步最多 40 次物理模拟卡主线程**(ThreeDice.ts:335,423-436);solve 期间先 render 起手帧 + 限制预算
